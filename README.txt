...
######何为kift？
1，kiftd是一款使用简单、功能齐全的小型网盘搭建系统。您只需一个浏览器，您就可以在办公室内、家中、小型局域网内共享您的任何文件，甚至是让您的朋友在线播放上传的视频——而无需下载。
...
第四步：管理功能
现在，您可以先使用内置用户(admin,000000)进行登录，并进行创建文件夹、删除文件或文件夹、上传文件操作。至于如何设置更多的用户并管理，请阅读《用户授权》部分。
